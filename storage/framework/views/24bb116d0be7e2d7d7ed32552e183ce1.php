...
```javascript
const url = new URL(
    "<?php echo rtrim($baseUrl, '/'); ?>/<?php echo e(ltrim($endpoint->boundUri, '/')); ?>"
);
...
```
<?php /**PATH C:\Users\S7so1\Desktop\lab\backend\resources\views/vendor/scribe/partials/example-requests/javascript.md.blade.php ENDPATH**/ ?>